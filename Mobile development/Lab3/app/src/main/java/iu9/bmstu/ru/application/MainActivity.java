    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_bar_update: {
                ...
                data = new ArrayList<>();
                new NewsAsyncTask(MainActivity.this,data,newsAdapter).execute(makeUri(getResources().getStringArray(R.array.magazine)[index]));
                break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerMagazine.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position != -1) {
                    data = new ArrayList<>();
                    new NewsAsyncTask(MainActivity.this,data,newsAdapter).execute(makeUri(array[position]));
                }
            }
            @Override
