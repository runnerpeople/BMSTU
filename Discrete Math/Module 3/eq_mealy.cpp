...
class Mealy{
        ...
        public:
                ...
                void equal(Mealy second) {
                        if (this->n!=second.n || this->m!=second.m || this->q!=second.q) {
                            cout << "NOT EQUAL" << endl;
                            return;
                        }
                        bool exit = false;
                        for(int i=0;i<this->n;i++) {
                            for(int j=0;j<this->m;j++) {
                                    if (delta[i][j]!=second.delta[i][j]) {
                                        cout << "NOT EQUAL" << endl;
                                        exit = true;
                                        break;
                                    }
                                    if (phi[i][j]!=second.phi[i][j]) {
                                        cout << "NOT EQUAL" << endl;
                                        exit = true;
                                        break;
                                    }
...
int main() {
        ...
        int n1,m1,q1;
        cin >> n1 >> m1 >> q1;
        Mealy s(n1,m1,q1,true);
        f.AufenkampHohn().canon().equal(s.AufenkampHohn().canon());
        return 0;
}
